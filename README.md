...
[![CI](https://github.com/Roberdan/convergio-kernel/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-kernel/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-kernel/blob/main/LICENSE)
[![Rust](https://img.shields.io/badge/rust-stable-orange)](https://www.rust-lang.org/)
[![Zero Warnings](https://img.shields.io/badge/warnings-0-brightgreen)](#)

Execution kernel — process lifecycle, sandbox isolation, resource limits
...
```mermaid
graph LR
    CRATE[convergio-kernel] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-kernel = { git = "https://github.com/Roberdan/convergio-kernel", tag = "v0.1.0" }
```
